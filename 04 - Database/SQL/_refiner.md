...
> Older SQL notes may still sit under `Java/12 - Databases and SQL/`. New graduated SQL notes land in `04 - Database/SQL/`; if you move an old one, **move it** (don't copy) to keep one home per item.
