...
- **SOLID** helps organize classes and dependencies.
- **Inheritance** explains how subclasses reuse and specialize behaviour.
- **`Object`** provides methods available to every Java object.
- **`static`** separates class-level state from object-level state.
- **Exception handling** lets a program respond to recoverable runtime problems.
